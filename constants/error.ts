 ...
 * @LastEditTime: 2022-06-17 14:10:32
 * @FilePath: /access_db/constants/error.ts
...
export const TRAN_RUN_ERROR = 'The transaction function run(sql), the sql is not string type.'
export const TRAN_CONNECTION_ERROR = 'The transaction wrong, make sure do something is in beigin(callback)callback.'
