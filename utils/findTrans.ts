import {PLATFORM_NAME, J_NAME_LIST} from '../constants/constants.ts'
import {FIND_CHECKR_ERROR, FIND_P_ERROR, FIND_P_BETWEEN_ERROR, FIND_NO_PJ_ERROR, PARAMS_EMPTY_ARR_ERROR} from '../constants/error.ts'
import {changeFindGeoJson, isArray, changeSqlParam, isMongodbObjectId} from './utils.ts'

export default function findTrans<T>(params: T | any, r_num: number, query_data: any, dbType: any){
