...
import {isArray, changeSqlParam, isMongodbObjectId} from './utils.ts'
import {UPDATE_ERROR} from '../constants/error.ts'
// import { mongodbId } from './dbMongodb'
import updateTrans from './updateTrans.ts'

export default function updatemanyTrans<T>(params: T, query: any, dbType: any){
